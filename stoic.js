const quotes = [
  ...
  {
    text:
      'Plato says: "Every king springs from a race of slaves, and every slave has had kings among his ancestors." The flight of time, with its vicissitudes, has jumbled all such things together, and Fortune has turned them upside down.',
    author: "Seneca",
  },
  {
    text:
  ...
  {
    text:
      "Lay hold of today's task, and you will not need to depend so much upon to-morrow's. While we are postponing, life speeds by.",
    author: "Seneca",
  },
  {
  ...
  {
    text:
      "Everywhere, at each moment, you have the option: to accept this event with humility, to treat this person as he should be treated, or to approach this thought with care, so that nothing irrational creeps in.",
    author: "Marcus Aurelius",
  },
  {
    text:
